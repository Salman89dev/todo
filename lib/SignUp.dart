    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child:  Column(
          ...
          children: [
            Text("Register",style: TextStyle(fontSize: 32,color: Colors.white,fontWeight: FontWeight.w700),),
            SizedBox(height: 30,),
            ...
            SizedBox(height: 30,),
            Text("Confirm Password",style: TextStyle(fontSize: 16,color: Color.fromARGB(207, 255, 255, 255),fontWeight: FontWeight.w500),),
            SizedBox(height: 10,),
            const TextField(
              style: TextStyle(color: Colors.white),
              obscureText: true,
            ...
            Container(
              ...
              }, child: Text("Already have an account? Login",style: TextStyle(fontSize: 16,color: Color.fromARGB(255, 151, 151, 151)),)),
            )
